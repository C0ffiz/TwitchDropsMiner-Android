...
DEFAULT_CLIENT_TYPE: ClientInfo = ClientType.ANDROID_APP  # Device code OAuth; matches upstream; no Client-Integrity required
...
CLIENT_URL: str = DEFAULT_CLIENT_TYPE.CLIENT_URL  # Android-specific: shim
